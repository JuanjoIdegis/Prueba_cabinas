/**
 * QRCode for JavaScript (Standalone / Offline)
 * Permite renderizar códigos QR directamente en Canvas y elementos DOM
 */
var QRCode;
...
(function () {
	...
	QRCodeModel.createData = function (typeNumber, errorCorrectLevel, dataList) {
		...
		if (buffer.getLengthInBits() > totalDataCount * 8) {
			throw new Error("Tamaño de datos excede la capacidad (" + buffer.getLengthInBits() + ">" + totalDataCount * 8 + " bits)");
		}
	...
	QRCode.prototype.makeCode = function (sText) {
		...
		// Buscar menor typeNumber que quepa
		for (var t = 1; t <= 10; t++) {
			try {
				this._oQRCode = new QRCodeModel(t, this._htOption.correctLevel);
				this._oQRCode.addData(sText);
				this._oQRCode.make();
				break;
			} catch (e) {
